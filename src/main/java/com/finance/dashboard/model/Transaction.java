...
public class Transaction {
    ...
    public Transaction() {}
    private Transaction(Builder b){this.id=b.id;this.amount=b.amount;this.type=b.type;this.category=b.category;this.date=b.date;this.notes=b.notes;this.deleted=b.deleted;this.createdBy=b.createdBy;}
    public static Builder builder(){return new Builder();}
    public static class Builder {
        private Long id; private BigDecimal amount; private TransactionType type; private String category; private LocalDate date; private String notes; private boolean deleted=false; private User createdBy;
    ...
    public boolean isDeleted(){return deleted;} public void setDeleted(boolean v){this.deleted=v;}
    public User getCreatedBy(){return createdBy;} public void setCreatedBy(User v){this.createdBy=v;}
