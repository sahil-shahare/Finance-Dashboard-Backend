...
public class TransactionController {
    ...
    public ResponseEntity<ApiResponse<PagedResponse<TransactionResponse>>> getTransactions(
        ...
        return ResponseEntity.ok(ApiResponse.success(
                transactionService.getTransactions(type, category, startDate, endDate, page, size)));
    }
    ...
    public ResponseEntity<ApiResponse<TransactionResponse>> createTransaction(
        ...
        return ResponseEntity.status(HttpStatus.CREATED).body(ApiResponse.success("Transaction created",
    ...
    public ResponseEntity<ApiResponse<Void>> deleteTransaction(@PathVariable Long id) {
        ...
        return ResponseEntity.ok(ApiResponse.success("Transaction deleted (soft)", null));
    }
}
